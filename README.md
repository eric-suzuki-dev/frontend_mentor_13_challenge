# Frontend Mentor - 13 huddle-landing-page-with-single-introductory-section

Esta é uma solução do [huddle-landing-page-with-single-introductory-section](https://www.frontendmentor.io/challenges/huddle-landing-page-with-a-single-introductory-section-B_2Wvxgi0). Os desafios do Frontend Mentor ajudam a melhorar suas habilidades de codificação, construindo projetos realistas.

"This is a solution to the [single-price-grid-component-master](https://www.frontendmentor.io/challenges/huddle-landing-page-with-a-single-introductory-section-B_2Wvxgi0). Frontend Mentor challenges help you improve your coding skills by building realistic projects."

## Sumário (Summary)

- [Frontend Mentor - 13 huddle-landing-page-with-single-introductory-section](#frontend-mentor---13-huddle-landing-page-with-single-introductory-section)
...
![Desktop and Mobile](./13-huddle-landing-page-with-single-introductory-section.png)
